...
namespace Data.Modelo
{
    ...
    partial void DeleteUsuarioPermiso(UsuarioPermiso instance);
		...
		[Function(Name="dbo.PermisosDispUsuario")]
		public ISingleResult<Permiso> PermisosDispUsuario([Parameter(DbType="Int")] System.Nullable<int> idPerfil, [Parameter(DbType="Int")] System.Nullable<int> idUsuario)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), idPerfil, idUsuario);
			return ((ISingleResult<Permiso>)(result.ReturnValue));
		}
	}
    ...
    partial void OnLineaChanged();
		...
		[Association(Name="Articulo_OrdenTrabajo", Storage="_OrdenTrabajos", OtherKey="IdArticulo")]
		...
		[Association(Name="Categoria_Articulo", Storage="_Categoria1", ThisKey="Categoria", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="Linea_Articulo", Storage="_Linea1", ThisKey="Linea", IsForeignKey=true, DeleteRule="CASCADE")]
		public Linea Linea1
		{
			get
			{
		...
		[Association(Name="Marca_Articulo", Storage="_Marca1", ThisKey="Marca", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Marca Marca1
		{
			get
			{
		...
		[Association(Name="PrecioGarantia_Articulo", Storage="_PrecioGarantia1", ThisKey="PrecioGarantia", IsForeignKey=true, DeleteRule="CASCADE")]
		...
		[Association(Name="TipoArticulo_Articulo", Storage="_TipoArticulo1", ThisKey="TipoArticulo", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnIdTipoEspecialidadChanged();
		...
		[Association(Name="Categoria_Articulo", Storage="_Articulos", OtherKey="Categoria")]
		...
		[Association(Name="TipoEspecialidad_Categoria", Storage="_TipoEspecialidad", ThisKey="IdTipoEspecialidad", IsForeignKey=true)]
    ...
    partial void OnIdDireccionChanged();
		...
		[Association(Name="Cliente_ClienteComercial", Storage="_ClienteComercial", ThisKey="Id", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="Cliente_ClienteParticular", Storage="_ClienteParticular", ThisKey="Id", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="Cliente_Contacto", Storage="_Contactos", OtherKey="IdCliente")]
		...
		[Association(Name="Cliente_OrdenTrabajo", Storage="_OrdenTrabajos", OtherKey="IdCliente")]
		public EntitySet<OrdenTrabajo> OrdenTrabajos
		{
			get
			{
		...
		[Association(Name="Direccion_Cliente", Storage="_Direccion", ThisKey="IdDireccion", IsForeignKey=true)]
		...
		[Association(Name="TipoCliente_Cliente", Storage="_TipoCliente1", ThisKey="TipoCliente", IsForeignKey=true)]
    ...
    partial void OnSucursalChanged();
		...
		[Association(Name="Cliente_ClienteComercial", Storage="_Cliente", ThisKey="Id", IsForeignKey=true)]
    ...
    partial void OnApellidoMaternoChanged();
		...
		[Association(Name="Cliente_ClienteParticular", Storage="_Cliente", ThisKey="Id", IsForeignKey=true)]
		public Cliente Cliente
		{
			get
			{
    ...
    partial void OnNombreChanged();
		...
		[Association(Name="Comuna_Direccion", Storage="_Direccions", OtherKey="Comuna")]
    ...
    partial void OnIdClienteChanged();
		...
		[Association(Name="Cliente_Contacto", Storage="_Cliente", ThisKey="IdCliente", IsForeignKey=true)]
		public Cliente Cliente
		{
			get
			{
		...
		[Association(Name="TipoContacto_Contacto", Storage="_TipoContacto1", ThisKey="TipoContacto", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void OnIdUsuarioChanged();
		...
		[Association(Name="Estado_Detalle", Storage="_Estado1", ThisKey="Estado", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="OrdenTrabajo_Detalle", Storage="_OrdenTrabajo", ThisKey="IdOrden", IsForeignKey=true, DeleteRule="CASCADE")]
		...
		[Association(Name="Usuario_Detalle", Storage="_Usuario", ThisKey="IdUsuario", IsForeignKey=true)]
    ...
    partial void OnTipoDireccionChanged();
		...
		[Association(Name="Direccion_Cliente", Storage="_Clientes", OtherKey="IdDireccion")]
		...
		[Association(Name="Comuna_Direccion", Storage="_Comuna1", ThisKey="Comuna", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="Provincia_Direccion", Storage="_Provincia1", ThisKey="Provincia", IsForeignKey=true)]
		...
		[Association(Name="Region_Direccion", Storage="_Region1", ThisKey="Region", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="TipoDireccion_Direccion", Storage="_TipoDireccion1", ThisKey="TipoDireccion", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnIdTecnicoChanged();
		...
		[Association(Name="Tecnico_Especialidade", Storage="_Tecnico", ThisKey="IdTecnico", IsForeignKey=true)]
		...
		[Association(Name="TipoEspecialidad_Especialidade", Storage="_TipoEspecialidad1", ThisKey="TipoEspecialidad", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_IdEstado", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Estado_Detalle", Storage="_Detalles", OtherKey="Estado")]
    ...
    partial void OnIdOrdenChanged();
		...
		[Association(Name="OrdenTrabajo_HistorialModificacionOrden", Storage="_OrdenTrabajo", ThisKey="IdOrden", IsForeignKey=true, DeleteRule="CASCADE")]
		public OrdenTrabajo OrdenTrabajo
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_IdLinea", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Linea_Articulo", Storage="_Articulos", OtherKey="Linea")]
		public EntitySet<Articulo> Articulos
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_IdMarca", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Marca_Articulo", Storage="_Articulos", OtherKey="Marca")]
		public EntitySet<Articulo> Articulos
		{
			get
			{
    ...
    partial void OnDescripcionOpcionChanged();
		...
		[Association(Name="Modulo_Permiso", Storage="_Permisos", OtherKey="Mod_Id")]
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_IdNivel", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Nivel_Tecnico", Storage="_Tecnicos", OtherKey="Nivel")]
    ...
    partial void OnIdClienteChanged();
		...
		[Association(Name="OrdenTrabajo_Detalle", Storage="_Detalles", OtherKey="IdOrden")]
		public EntitySet<Detalle> Detalles
		{
			get
			{
		...
		[Association(Name="OrdenTrabajo_HistorialModificacionOrden", Storage="_HistorialModificacionOrdens", OtherKey="IdOrden")]
		...
		[Association(Name="Articulo_OrdenTrabajo", Storage="_Articulo", ThisKey="IdArticulo", IsForeignKey=true, DeleteRule="CASCADE")]
		...
		[Association(Name="Cliente_OrdenTrabajo", Storage="_Cliente", ThisKey="IdCliente", IsForeignKey=true)]
		public Cliente Cliente
		{
			get
			{
		...
		[Association(Name="Tecnico_OrdenTrabajo", Storage="_Tecnico", ThisKey="IdTecnicoAsignado", IsForeignKey=true)]
		public Tecnico Tecnico
		{
			get
			{
		...
		[Association(Name="TipoOrden_OrdenTrabajo", Storage="_TipoOrden1", ThisKey="TipoOrden", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void OnDescripcionOpcionChanged();
		...
		[Association(Name="Modulo_Permiso", Storage="_Modulo", ThisKey="Mod_Id", IsForeignKey=true)]
    ...
    partial void OnIdPrecioChanged();
		...
		[Association(Name="PrecioGarantia_Porcentaje", Storage="_PrecioGarantia", ThisKey="IdPrecio", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnValorReparacionChanged();
		...
		[Column(Storage="_IdPrecioGarantia", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="PrecioGarantia_Articulo", Storage="_Articulos", OtherKey="PrecioGarantia")]
		public EntitySet<Articulo> Articulos
		{
			get
			{
		...
		[Association(Name="PrecioGarantia_Porcentaje", Storage="_Porcentajes", OtherKey="IdPrecio")]
    ...
    partial void OnIdRegionChanged();
		...
		[Association(Name="Provincia_Direccion", Storage="_Direccions", OtherKey="Provincia")]
		public EntitySet<Direccion> Direccions
		{
			get
			{
		...
		[Association(Name="Region_Provincia", Storage="_Region", ThisKey="IdRegion", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnNombreChanged();
		...
		[Association(Name="Region_Direccion", Storage="_Direccions", OtherKey="Region")]
		public EntitySet<Direccion> Direccions
		{
			get
			{
		...
		[Association(Name="Region_Provincia", Storage="_Provincias", OtherKey="IdRegion")]
    ...
    partial void OnNivelChanged();
		...
		[Association(Name="Tecnico_Especialidade", Storage="_Especialidades", OtherKey="IdTecnico")]
		...
		[Association(Name="Tecnico_OrdenTrabajo", Storage="_OrdenTrabajos", OtherKey="IdTecnicoAsignado")]
		public EntitySet<OrdenTrabajo> OrdenTrabajos
		{
			get
			{
		...
		[Association(Name="Nivel_Tecnico", Storage="_Nivel1", ThisKey="Nivel", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Nivel Nivel1
		{
			get
			{
		...
		[Association(Name="Usuario_Tecnico", Storage="_Usuario", ThisKey="Id", IsForeignKey=true)]
		public Usuario Usuario
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_IdTipoArticulo", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="TipoArticulo_Articulo", Storage="_Articulos", OtherKey="TipoArticulo")]
		public EntitySet<Articulo> Articulos
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Association(Name="TipoCliente_Cliente", Storage="_Clientes", OtherKey="TipoCliente")]
		public EntitySet<Cliente> Clientes
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Association(Name="TipoContacto_Contacto", Storage="_Contactos", OtherKey="TipoContacto")]
		public EntitySet<Contacto> Contactos
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Association(Name="TipoDireccion_Direccion", Storage="_Direccions", OtherKey="TipoDireccion")]
		public EntitySet<Direccion> Direccions
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_IdTipoEspecialidad", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="TipoEspecialidad_Categoria", Storage="_Categorias", OtherKey="IdTipoEspecialidad")]
		...
		[Association(Name="TipoEspecialidad_Especialidade", Storage="_Especialidades", OtherKey="TipoEspecialidad")]
		public EntitySet<Especialidade> Especialidades
		{
			get
			{
    ...
    partial void OnDescripcionChanged();
		...
		[Column(Storage="_IdTipoOrden", AutoSync=AutoSync.OnInsert, DbType="Decimal(18,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="TipoOrden_OrdenTrabajo", Storage="_OrdenTrabajos", OtherKey="TipoOrden")]
		public EntitySet<OrdenTrabajo> OrdenTrabajos
		{
			get
			{
    ...
    partial void OnActivoChanged();
		...
		[Association(Name="Usuario_Detalle", Storage="_Detalles", OtherKey="IdUsuario")]
		public EntitySet<Detalle> Detalles
		{
			get
			{
		...
		[Association(Name="Usuario_Tecnico", Storage="_Tecnico", ThisKey="Id", IsUnique=true, IsForeignKey=false)]
		public Tecnico Tecnico
		{
			get
			{
		...
		[Association(Name="Usuario_UsuarioPermiso", Storage="_UsuarioPermisos", OtherKey="IdUsuario")]
		public EntitySet<UsuarioPermiso> UsuarioPermisos
		{
			get
			{
		...
		[Association(Name="Perfil_Usuario", Storage="_Perfil", ThisKey="PerfilUsuario", IsForeignKey=true)]
		public Perfil Perfil
		{
			get
			{
    ...
    partial void OnEstadoChanged();
		...
		[Association(Name="Permiso_UsuarioPermiso", Storage="_Permiso", ThisKey="IdPermiso", IsForeignKey=true)]
		public Permiso Permiso
		{
			get
			{
		...
		[Association(Name="Usuario_UsuarioPermiso", Storage="_Usuario", ThisKey="IdUsuario", IsForeignKey=true)]
		public Usuario Usuario
		{
			get
			{
