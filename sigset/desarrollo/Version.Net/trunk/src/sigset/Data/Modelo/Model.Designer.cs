...
namespace Data.Modelo
{
    ...
    partial void DeleteUsuarioPermiso(UsuarioPermiso instance);
		...
		public ISingleResult<Permiso> PermisosDispUsuario([Parameter(DbType="Int")] System.Nullable<int> idPerfil, [Parameter(DbType="Int")] System.Nullable<int> idUsusario)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), idPerfil, idUsusario);
			return ((ISingleResult<Permiso>)(result.ReturnValue));
		}
	}
