...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="three-column-container">
        <div class="three-column-left">
            <p>
                Modelo:
                <%= Html.Encode(String.Format("{0}", Model.Articulo.Modelo)) %>
            </p>
        </div>
        <div class="three-column-middle">
            <p>
                Marca:
                <%= Html.Encode(String.Format("{0}", Model.Articulo.Marca1.Descripcion)) %>
                <p>
        </div>
        <div class="three-column-right">
            <p>
                Linea:
                <%= Html.Encode(String.Format("{0}", Model.Articulo.Linea1.Descripcion)) %>
            </p>
        </div>
    </div>
    <p>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MenuDerecha" runat="server">
    <ul>
        ...
        <li>
            <%=Html.ActionLink("Exportar a Excel","Detalles",new {id=Model.Id,format="xls"}) %></li>
    </ul>
</asp:Content>
